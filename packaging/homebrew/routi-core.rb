...
class RoutiCore < Formula
  ...
  url "https://github.com/narralabs/routi/releases/download/v0.1.33/routi-core.tar.gz"
  sha256 "4227be00e02ad6feee5c813543041f13321557cf574dba9a81568a405f97ce4f"
