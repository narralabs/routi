...
final class ConnectSubscriptionTests: XCTestCase {
    ...
    func testPurchaseRestoreAndWrongMac() async throws {
        ...
        await billing.restore(profile)
        XCTAssertEqual(billing.message, "No active Connect subscription was found for this Mac.")
        XCTAssertEqual(BillingProtocol.claims, 0)
